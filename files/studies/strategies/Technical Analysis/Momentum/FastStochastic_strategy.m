function [params,sig] = FastStochastic_strategy(x,price)
%% Fast Stochastic Oscillator strategy
...
% OPTIMIZATION RANGE
params.k =  [2:2:12, 15:3:35, 40:5:60, 70:10:500];         % %K
params.d = [2:2:12, 15:3:35, 40:5:60, 70:10:500];          % %D
...
output = indicators([price.High,price.Low,price.Close],'fsto',k,d);
fpctk = output(:,1);
fpctd = output(:,2);
...
% RULES
sig(fpctk >= fpctd) = 1; % buy 1 amount of asset
sig(fpctk < fpctd) = -1; % sell short 1 amount of asset
