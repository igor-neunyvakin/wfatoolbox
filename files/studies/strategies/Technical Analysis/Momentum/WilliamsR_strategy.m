function [params,sig] = WilliamsR_strategy(x,price)
%% Williams %R strategy
...
% OPTIMIZATION RANGE
params.per =  [2:2:12, 15:3:35, 40:5:60, 70:10:500];         % period
...
willr = indicators([price.High,price.Low,price.Close],'william',per);
...
% RULES
sig(willr >= -50) = 1; % buy 1 amount of asset
sig(willr < -50) = -1; % sell short 1 amount of asset
