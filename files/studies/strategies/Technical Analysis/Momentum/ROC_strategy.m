function [params,sig] = ROC_strategy(x,price)
...
% OPTIMIZATION RANGE
params.per =  [2:2:12, 15:5:35, 40:10:50];         % period of moving average
params.perc = 0.01:0.01:0.1;                                   % percent of change
...
roc = indicators(price.Price,'roc',per);
...
upper_thresh = perc;
lower_thresh = -perc;
sig(roc >= upper_thresh) = 1; % buy 1 amount of asset
sig(roc < lower_thresh) = -1; % sell short 1 amount of asset
