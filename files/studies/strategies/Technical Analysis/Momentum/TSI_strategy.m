function [params,sig] = TSI_strategy(x,price)
...
% OPTIMIZATION RANGE
params.r =  [2:2:12, 15:3:35, 40:5:60, 70:10:200];         % period of momentum
params.s =  [2:2:12, 15:3:35, 40:5:60, 70:10:200];         % period of smoothed momentum
...
tsi = indicators([price.High,price.Low,price.Close],'tsi',r,s);
...
% RULES
sig(tsi >= 0) = 1; % buy 1 amount of asset
sig(tsi < 0) = -1; % sell short 1 amount of asset
