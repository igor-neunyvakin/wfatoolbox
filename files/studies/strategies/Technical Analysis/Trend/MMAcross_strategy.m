function [params,sig] = MMAcross_strategy(x,price)
%% Modified Moving Averages crossover strategy
...
lead_ma = movavg(price.Price,'modified',lead);
lag_ma = movavg(price.Price,'modified',lag);
