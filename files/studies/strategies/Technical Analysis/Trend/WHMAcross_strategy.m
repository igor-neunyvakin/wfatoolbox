function [params,sig] = WHMAcross_strategy(x,price)
%% Weighted Hull Moving Averages crossover strategy
...
lead_ma = I_Complex_MA('whma',price.Price,lead);
lag_ma = I_Complex_MA('whma',price.Price,lag);
