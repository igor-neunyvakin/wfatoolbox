function [params,sig] = TEMAcross_strategy(x,price)
...
params.lag =  [1:1:10, 15:5:50, 60:10:100];       % period of lag moving average
...
if ~exist('tsmovavg.m','file')
    msgbox('To run this strategy you need to have Financial Toolbox')
    stop = 1;
end
...
lead_ma = I_Complex_MA('tema',price.Price,lead);
lag_ma = I_Complex_MA('tema',price.Price,lead+lag);
