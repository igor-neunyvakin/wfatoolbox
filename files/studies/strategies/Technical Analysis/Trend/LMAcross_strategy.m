function [params,sig] = LMAcross_strategy(x,price)
%% Linear Moving Averages crossover strategy
...
lead_ma = movavg(price.Price,'linear',lead);
lag_ma = movavg(price.Price,'linear',lag);
