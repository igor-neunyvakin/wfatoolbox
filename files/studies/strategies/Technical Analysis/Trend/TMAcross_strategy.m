function [params,sig] = TMAcross_strategy(x,price)
%% Triangular Moving Averages crossover strategy
...
params.lag =  [1:1:12, 15:3:50, 60:10:100];       % period of lag moving average
...
lead_ma = movavg(price.Price,'triangular',lead);
lag_ma = movavg(price.Price,'triangular',lead+lag);
