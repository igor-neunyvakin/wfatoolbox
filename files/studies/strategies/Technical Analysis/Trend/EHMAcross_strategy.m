function [params,sig] = EHMAcross_strategy(x,price)
%% Exponential Hull Moving Averages crossover strategy
...
lead_ma = I_Complex_MA('ehma',price.Price,lead);
lag_ma = I_Complex_MA('ehma',price.Price,lead+lag);
