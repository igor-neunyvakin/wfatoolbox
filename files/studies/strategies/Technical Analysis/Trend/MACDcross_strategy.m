function [params,sig] = MACDcross_strategy(x,price)
...
output  = indicators(price.Price,'macd',lead,lead+lag,smooth_per);
macd = output(:,1); % macd
signal = output(:,2); % moving average of macd
...
% RULES
sig(macd >= signal) = 1; % buy 1 amount of asset
sig(macd < signal) = -1; % sell short 1 amount of asset
