function [params,sig] = TRIXcross_strategy(x,price)
%% Three-Times Exponential Moving Averages crossover strategy
...
lead_ma = I_Complex_MA('trix',price.Price,lead);
lag_ma = I_Complex_MA('trix',price.Price,lag);
