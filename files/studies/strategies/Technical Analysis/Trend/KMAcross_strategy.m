function [params,sig] = KMAcross_strategy_copy(x,price)
%% Kaufman Adaptivel Moving Averages crossover strategy
...
% OPTIMIZATION RANGE
params.lag1 = [2:2:12, 15:5:35];        % efficiency lag #1
params.rfi1 =  [5:2:12, 15:5:50];       % recent/fast index #1
params.dsi1 =  [2:2:12, 15:5:50, 60:10:100];       % distant/slow index #1
params.lag2 = [2:2:12, 15:5:35];        % efficiency lag #2
params.rfi2 =  [5:2:12, 15:5:50];       % recent/fast index #2
params.dsi2 =  [2:2:12, 15:5:50, 60:10:100];       % distant/slow index #2
...
% enter "edit I_Complex_MA" in the command window
lead_ma = I_Complex_MA('kma',price.Price,[lag1,rfi1,rfi1+dsi1]);
lag_ma = I_Complex_MA('kma',price.Price,[lag2,rfi2,rfi2+dsi2]);
