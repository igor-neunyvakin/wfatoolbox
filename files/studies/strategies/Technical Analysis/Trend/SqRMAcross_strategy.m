function [params,sig] = SqRMAcross_strategy(x,price)
%% Square-Root Moving Averages crossover strategy
...
lead_ma = movavg(price.Price,'square-root',lead);
lag_ma = movavg(price.Price,'square-root',lag);
