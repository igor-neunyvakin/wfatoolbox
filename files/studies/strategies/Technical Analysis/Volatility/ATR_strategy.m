function [params,sig] = ATR_strategy(x,price)
...
% OPTIMIZATION RANGE
params.period = [2:2:12, 15:3:35, 40:5:60, 70:10:150];       % number of periods
params.thresh = 1:10:1000;
...
atr = indicators([price.High,price.Low,price.Close],'atr',period);
...
% RULES
sig(atr >= thresh) = 1; % buy 1 amount of asset
sig(atr < thresh) = -1; % sell short 1 amount of asset
