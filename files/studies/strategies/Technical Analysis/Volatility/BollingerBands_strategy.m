function [params,sig] = BollingerBands_strategy(x,price)
...
% OPTIMIZATION RANGE
params.period = [2:2:12, 15:3:35, 40:5:60];        % number of periods
params.weight =  1:10;                                          % weight factor
params.nstd =  1:10;                                            % number of standard deviations
...
output= indicators(price.Price,'boll',period,weight,nstd);
middle = output(:,1);
upper = output(:,2);
lower = output(:,3);
