...
%               streaming = oandafunctions.OandaFunctions();
              ...
              addpath([pathstr, '/jsonlab-1.2']); % Json toolbox
              addpath([pathstr, '/urlread2']); % urlread2
%               javaaddpath([pathstr,'/lib/OandaFunctions.jar']);%methodsview oandafunctions.OandaFunctions
              javaaddpath([pathstr,'/lib/httpclient-4.3.3.jar']);
                 javaaddpath([pathstr,'/lib/httpclient-cache-4.3.3.jar']);
                 javaaddpath([pathstr,'/lib/commons-cli-1.2.jar']);
                 javaaddpath([pathstr,'/lib/commons-codec-1.6.jar']);%methodsview oandafunctions.OandaFunctions
                 javaaddpath([pathstr,'/lib/commons-logging-1.1.3.jar']);
                 javaaddpath([pathstr,'/lib/fluent-hc-4.3.3.jar']);
                 javaaddpath([pathstr,'/lib/httpcore-4.3.2.jar']);
                 javaaddpath([pathstr,'/lib/httpcore-ab-4.3.2.jar']);
                 javaaddpath([pathstr,'/lib/httpcore-nio-4.3.2.jar']);
                 javaaddpath([pathstr,'/lib/httpmime-4.3.3.jar']);
                 javaaddpath([pathstr,'/lib/json-simple-1.1.1.jar']);
                 javaaddpath([pathstr,'/lib/commons-io-2.4.jar']);
...
%                        startdate = int32(floor(86400 * (startdate - datenum('01-Jan-1970'))))
                       startdate = datestr(startdate,'yyyy-mm-ddTHH:MM:SS.FFF000Z');%'yyyy-mm-ddTHH:MM:SS.FFFZ');
                       startdate = strrep(startdate, ':', '%3A');
...
%                        enddate = int32(floor(86400 * (enddate - datenum('01-Jan-1970'))))
                       enddate = datestr(enddate,'yyyy-mm-ddTHH:MM:SS.FFF000Z');%'yyyy-mm-ddTHH:MM:SS.FFFZ');
                       enddate = strrep(enddate, ':', '%3A');
